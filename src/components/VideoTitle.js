  ...
  return (
    <div className='w-full aspect-video md:py-20 px-10   md:px-12 absolute bg-gradient-to-r from-black'>
      ...
      <h1 className='text-xl md:text-2xl mt-28 font-bold text-white md:mt-8 hidden md:block'>{title}</h1>
        ...
        <div className='mt-24 md:-my-0  flex  '>
            <button className='bg-white text-black  w-24 rounded-md hover:bg-opacity-85'>▶Play</button>
            <button className='bg-gray-500 text-white  ml-4 rounded-md bg-opacity-50 hover:bg-opacity-25'>ℹ️More Info</button>
        </div>
      </div>
